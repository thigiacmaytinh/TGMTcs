    ...
    public partial class Canvas : UserControl
    {
        ...
        private void startFT()
        {
            if (pictureItem != null)
            {
                ...
                rect[0] = vertex[0] = new PointF(imageLocation.X, imageLocation.Y);
                rect[1] = vertex[1] = new PointF(imageLocation.X + pictureItem.Width, imageLocation.Y);
                rect[2] = vertex[2] = new PointF(imageLocation.X + pictureItem.Width, imageLocation.Y + pictureItem.Height);
                rect[3] = vertex[3] = new PointF(imageLocation.X, imageLocation.Y + pictureItem.Height);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (pictureItem != null)
            {
                ...
                g.DrawPolygon(new Pen(Color.Blue), rect);
                for (int i = 0; i < 4; i++)
